...
print "---------------------------------"
print "reflective_hist0: "+str(sum(reflective_hist0)/len(reflective_hist0))
print "reflective_hist1: "+str(sum(reflective_hist1)/len(reflective_hist1))
print "beacon0: "+str(sum(beacon0)/len(beacon0))
print "beacon1: "+str(sum(beacon1)/len(beacon1))
print "ambient_hist0: "+str(sum(ambient_hist0)/len(ambient_hist0))
print "ambient_hist1: "+str(sum(ambient_hist1)/len(ambient_hist1))
print "proximity0: "+str(sum(proximity0)/len(proximity0))
print "proximity1: "+str(sum(proximity1)/len(proximity1))
print "---------------------------------"
